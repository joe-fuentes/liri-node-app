...
You'll use Request to grab data from the OMDB API. Instructions
...
Copy and paste them where the tags are inside your keys.js file. Step Four: At the bottom of the page, click the Create my access token button to get your access token key and secret.

Copy the access token key and secret displayed at the bottom of the next screen. Paste them where the tags are inside your keys.js file. Make a file called random.txt.
